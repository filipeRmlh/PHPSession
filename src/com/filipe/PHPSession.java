...
public final class PHPSession {
    ...
    public static String get(String sessionid,String param){
        ...
        if(catalina==null){
            return get(sessionid,param,System.getProperty("user.dir")+Paths.get("/"));
        }
        try {
            throw new InvalidPathException("","Você precisa fornecer o caminho para a pasta onde getSession.php se encontra");
